  ...
  <div class="fullscreen">
    <div class="login-box">
      ...
      <form action="" class="login-form">
        ...
        <el-row :gutter="20">
            <el-col :span="12"><button class="m-btn sub select-none" @click.prevent="handleLogin" v-loading="isLoging">登录</button></el-col>
            <el-col :span="12"><button class="m-btn sub select-none" @click="$router.push('/signup')">注册</button></el-col>
        </el-row>
      </form>
      <div style="margin-top: 50px"></div>
      <p class="text-tips">
        <i class="fa fa-meetup" style="color: #29ABE2"></i>&nbsp;
        <span class="footer-text">{{appName}} &nbsp;<el-tag size="mini">{{version}}</el-tag> <br>©make by <a href="https://www.github.com/an-liu1" target="_blank" class="m-link-effect">{{author}}</a>
    </span>
      </p>
    </div>
  </div>
